...
未修整のバグ<br>
CH7,CH8,CH9の末尾の”FE0C06”を入れ忘れていました。<br>
現状はノート番号24(C1)以上のデータのみ対応しています。<br>
ノート番号23(B0)以下のデータは変換結果がマイナスになってしまうため誤動作します…<br>
そのうち直します。<br><br>
改版履歴<br>
V1.0:小節またぎの音符が途切れていたので途切れないよう修正<br>
V0.4:小節またぎを正確に分割、変換誤差が出ないよう事前にMIDIデータをクオンタイズ<br>
